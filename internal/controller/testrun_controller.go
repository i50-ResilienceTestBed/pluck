...
// +kubebuilder:rbac:groups=chaos.galah-monitoring.io,resources=testruns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=chaos.galah-monitoring.io,resources=testruns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=chaos.galah-monitoring.io,resources=testruns/finalizers,verbs=update
